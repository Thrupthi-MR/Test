...
class ReportGenerator:
    """Generate irregular failure reports."""

    def __init__(self, dataframe):
        """Initialize report generator."""
        self.df = dataframe
        self.irregular_df = dataframe[
            dataframe["CATEGORY"] == "IRREGULAR_TEST_FAILURE"
        ]
    ...
    def create_summary_sheet(self, workbook):
        ...
        summary["A5"] = "Total Records"
        summary["B5"] = len(self.df)

        summary["A6"] = "Irregular Failures"
        summary["B6"] = len(self.irregular_df)
    ...
    def auto_adjust_width(self, worksheet):
    ...
    def generate_report(self):
        ...
        worksheet.title = "Irregular Failures"
        ...
        self.auto_adjust_width(worksheet)
